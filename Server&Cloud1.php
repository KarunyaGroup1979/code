                ...
                <div class="row">
                    <div class="cominSonn ">
                        <div class="lftComing col-6">
                            <h2>
                    <span class="Boldfont">Why Karunya IT Solutions(OPC) Pvt.Ltd for Public Cloud Hosting
                    Solutions?</span>
                </h2>
                            <p>We at Karunya IT Solutions(OPC) Pvt.Ltd plan, design and build public cloud computing solutions that reduce IT costs, streamline operations and accelerate time to market. With a comprehensive public cloud-focused</p>
                            <h6>Coming Soon</h6>
                        </div>
                ...
                <div class="uperContent">
                    <div class="row">
                        <div class="col-md-12  solution text-center">
                            <h2>
                        <span class="Boldfont"><span class="Boldfont_Blue">Why Karunya IT Solutions</span> for Public Cloud Hosting
                    Solutions?</span>
                    </h2>
                            <p>We at Karunya IT Solutions(OPC) Pvt.Ltd plan, design and build public cloud computing solutions that reduce IT costs, streamline operations and accelerate time to market. With a comprehensive public cloud-focused</p>
            ...
            <div class="uperContent">
                <div class="row">
                    ...
                    <h2>
                        ...
                        <p>Karunya IT Solutions(OPC) Pvt.Ltd team has expertise in 3 leading cloud platforms – <b>AWS, Azure and Google Cloud along With Data Center technologies including VMware, Hyper-V, Open Stack.</b>
                        </p>
                    </div>
                </div>
            </div>
            <div class="cloudOffering">
                <div class="row">
                    <div class="col-md-6 innerContent ">
                        <h2>Karunya IT Solutions(OPC) Pvt.Ltd
                        ...
                        <div class="partner col-sm-12 text-center">
                          ...
                          <h2><span class="Boldfont">Our Public Cloud <span class="Boldfont_Blue">Services Partners </span></span></h2>
                            <ul>
                                ...
                                <li><img src="images/lenovo1.png" alt="" width="280px"></li>
                                <li><img src="images/apple.png" alt="" width="200px"></li>
                                <li><img src="images/hp.png" alt=""></li>
