                            ...
                            <ul class="navbar-nav mr-auto menus">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="Networking" style="font-size: 20px;">Networking</a>
                                         <a class="dropdown-item" href="software1" style="font-size: 20px;">Software Development</a>
                                         <a class="dropdown-item" href="Server&Cloud1" style="font-size: 20px;">Server & Cloud</a>
                                        <a class="dropdown-item" href="hardware1" style="font-size: 20px;">Hardware Services</a>
                                        <a class="dropdown-item" href="network-security" style="font-size: 20px;">Network-Security</a>
