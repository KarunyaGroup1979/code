...
<html>
    <head>
        ...
        <link rel="icon" href="images/karunya_global_logo_icon.jpeg" sizes="16x16">
            ...
            <div class="container">
                <center>
                     <div class="col-md-4"> 
                        <a href="#">
                            <div class="shadow-lg  ">
                                <img src="images/karunya_group_logo.jpeg" class="w-100" height="230">
                            </div>
                        </a> 
                     </div>
                </center> 
                 <div class="row mt-5">
                        ...
                        <center>
                            <a href="home1.php">
                                <div class="shadow-lg mb-5">
                                    <img src="images/karunya_infotech_original12.jpg" class="w-100">
                                </div>
                            </a>
                        </center>
                    </div>
                    <div class="col-md-6">
                        <center>
                            <a href="home.php">
                                <div class="shadow-lg mb-5">
                                    <img src="images/karunya_global_index_img.png" class="w-100 mt-5 pb-4" style="margin-bottom: 57px;">
                                </div>
                            </a>
                        </center>
                    </div>
